...
// BranchCustomExports SDK utility type

class BranchCustomExportsUtility
{
    ...
    public static function copy(BranchCustomExportsUtility $src): BranchCustomExportsUtility
    {
        $u = new BranchCustomExportsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
