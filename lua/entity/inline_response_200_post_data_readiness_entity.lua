-- BranchCustomExports SDK InlineResponse200PostDataReadiness entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local InlineResponse200PostDataReadinessEntity = {}
InlineResponse200PostDataReadinessEntity.__index = InlineResponse200PostDataReadinessEntity


function InlineResponse200PostDataReadinessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InlineResponse200PostDataReadinessEntity)
  self._name = "inline_response_200_post_data_readiness"
  self._client = client
...
function InlineResponse200PostDataReadinessEntity:get_name()
  return self._name
end


function InlineResponse200PostDataReadinessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InlineResponse200PostDataReadinessEntity.new(self._client, opts)
end
...
function InlineResponse200PostDataReadinessEntity:mark_deleted()
  self._deleted = true
end


function InlineResponse200PostDataReadinessEntity:deleted()
  return true == self._deleted
end


function InlineResponse200PostDataReadinessEntity:data_set(args)
  if args ~= nil then
...
function InlineResponse200PostDataReadinessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InlineResponse200PostDataReadinessEntity:match_set(args)
  if args ~= nil then
...
function InlineResponse200PostDataReadinessEntity:match_get()
...
function InlineResponse200PostDataReadinessEntity:stream(action, args, callopts)
...
---@param reqdata InlineResponse200PostDataReadinessCreateData
---@param ctrl? table
---@return InlineResponse200PostDataReadiness
---@return string? err
function InlineResponse200PostDataReadinessEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function InlineResponse200PostDataReadinessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return InlineResponse200PostDataReadinessEntity
