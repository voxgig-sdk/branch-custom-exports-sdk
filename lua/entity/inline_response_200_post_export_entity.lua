-- BranchCustomExports SDK InlineResponse200PostExport entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local InlineResponse200PostExportEntity = {}
InlineResponse200PostExportEntity.__index = InlineResponse200PostExportEntity


function InlineResponse200PostExportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InlineResponse200PostExportEntity)
  self._name = "inline_response_200_post_export"
  self._client = client
...
function InlineResponse200PostExportEntity:get_name()
  return self._name
end


function InlineResponse200PostExportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InlineResponse200PostExportEntity.new(self._client, opts)
end
...
function InlineResponse200PostExportEntity:mark_deleted()
  self._deleted = true
end


function InlineResponse200PostExportEntity:deleted()
  return true == self._deleted
end


function InlineResponse200PostExportEntity:data_set(args)
  if args ~= nil then
...
function InlineResponse200PostExportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InlineResponse200PostExportEntity:match_set(args)
  if args ~= nil then
...
function InlineResponse200PostExportEntity:match_get()
...
function InlineResponse200PostExportEntity:stream(action, args, callopts)
...
function InlineResponse200PostExportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return InlineResponse200PostExportEntity
