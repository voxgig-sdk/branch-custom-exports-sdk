...
// BranchCustomExports SDK InlineResponse200GetExport entity
...
class InlineResponse200GetExportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "inline_response_200_get_export";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new InlineResponse200GetExportEntity($this->_client, $opts);
    }

    /**
     * @param InlineResponse200GetExport|array $args InlineResponse200GetExport data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = BranchCustomExportsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return InlineResponse200GetExport|array The current InlineResponse200GetExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InlineResponse200GetExport fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = BranchCustomExportsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of InlineResponse200GetExport fields).
     */
    ...
    /**
     * Load a single InlineResponse200GetExport.
     *
     * @param InlineResponse200GetExportLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InlineResponse200GetExportLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InlineResponse200GetExport|array The loaded InlineResponse200GetExport as an assoc-array at the
     *   SDK boundary; throws BranchCustomExportsError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = BranchCustomExportsHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * Create a new InlineResponse200GetExport.
     *
     * @param InlineResponse200GetExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InlineResponse200GetExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InlineResponse200GetExport|array The created InlineResponse200GetExport as an assoc-array at the
     *   SDK boundary; throws BranchCustomExportsError on failure (item-5 convention).
     */
