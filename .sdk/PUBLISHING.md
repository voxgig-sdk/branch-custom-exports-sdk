...
|---|---|---|
| `js/` | @voxgig-sdk/branch-custom-exports-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-custom-exports | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-custom-exports-js \
      --repository voxgig-sdk/branch-custom-exports-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-custom-exports-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-custom-exports-js --id=<id>` removes it.
