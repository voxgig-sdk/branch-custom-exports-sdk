...
// BranchCustomExports SDK ratelimit feature
...
class BranchCustomExportsRatelimitFeature extends BranchCustomExportsBaseFeature
{
    ...
    private function _acquire(BranchCustomExportsContext $ctx): void
    {
    ...
    private function _track(BranchCustomExportsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
