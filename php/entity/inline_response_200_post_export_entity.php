...
class InlineResponse200PostExportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "inline_response_200_post_export";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new InlineResponse200PostExportEntity($this->_client, $opts);
    }

    /**
     * @param InlineResponse200PostExport|array $args InlineResponse200PostExport data (assoc-array) to store.
     */
    ...
    /**
     * @return InlineResponse200PostExport|array The current InlineResponse200PostExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InlineResponse200PostExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InlineResponse200PostExport fields).
     */
