...
class BranchCustomExportsTestRunner
{
    ...
    {
        $live = self::getenv('BRANCH_CUSTOM_EXPORTS_TEST_LIVE');
        $override = self::getenv('BRANCH_CUSTOM_EXPORTS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRANCH_CUSTOM_EXPORTS_TEST_EXPLAIN');
...
class_alias('BranchCustomExportsTestRunner', 'Runner');
class_alias('BranchCustomExportsHelpers', 'Helpers');
