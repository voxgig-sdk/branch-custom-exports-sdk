...
// BranchCustomExports SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BranchCustomExportsTestFeature extends BranchCustomExportsBaseFeature
{
    ...
    public function init(BranchCustomExportsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BranchCustomExportsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BranchCustomExportsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BranchCustomExportsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BranchCustomExportsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BranchCustomExportsParam::call($ctx, $k);
