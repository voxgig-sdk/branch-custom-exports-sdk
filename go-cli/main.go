// Command BranchCustomExports-cli is a CLI + REPL for the BranchCustomExports SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BRANCH_CUSTOM_EXPORTS_APIKEY (api key), BRANCH_CUSTOM_EXPORTS_BASE (base url override)")
