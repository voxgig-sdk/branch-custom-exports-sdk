...
const testSeed = `map[string]any{"entity": map[string]any{"inline_response_200_get_export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inline_response_200_post_data_readiness": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inline_response_200_post_export": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
