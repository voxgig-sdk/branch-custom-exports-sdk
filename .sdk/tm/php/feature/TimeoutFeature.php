...
// BranchCustomExports SDK timeout feature
...
class BranchCustomExportsTimeoutFeature extends BranchCustomExportsBaseFeature
{
    ...
    private function _with_timeout(BranchCustomExportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchCustomExportsContext $_ctx, float $ms): void
    {
        $client = $this->client;
