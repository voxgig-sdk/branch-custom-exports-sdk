...
import { BranchCustomExportsSDK, BaseFeature, stdutil } from '../../..'
...
describe('InlineResponse200PostExportEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of []) {
      if (!live && maybeSkipControl(t, 'entityOp', 'inline_response_200_post_export.' + op, live)) return
    }
    ...
    let inline_response_200_post_export_ref01_data = Object.values(setup.data.existing.inline_response_200_post_export)[0] as any
