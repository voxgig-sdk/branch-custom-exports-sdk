...
(0, node_test_1.describe)('InlineResponse200GetExportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BranchCustomExportsSDK({
    ...
    (0, node_test_1.test)('direct-load-inline_response_200_get_export', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-inline_response_200_get_export', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["request_handle01"]))
            return;
...
function liveScenariosActive() { return false && process.env.BRANCH_CUSTOM_EXPORTS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BranchCustomExportsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.BRANCH_CUSTOM_EXPORTS_APIKEY,
        }));
        let idmap = env['BRANCH_CUSTOM_EXPORTS_TEST_INLINE_RESPONSE_200_GET_EXPORT_ENTID'];
    ...
    const client = new __1.BranchCustomExportsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InlineResponse200GetExportDirect.test.js.map