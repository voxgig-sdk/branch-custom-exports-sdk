...
func registerSDKWords(r *eng.Registry, client *sdk.BranchCustomExportsSDK) {
...
func runOp(client *sdk.BranchCustomExportsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
