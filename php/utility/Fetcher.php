...
// BranchCustomExports SDK utility: fetcher

class BranchCustomExportsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchCustomExportsSDK/1.0)';
    ...
    public static function call(BranchCustomExportsContext $ctx, string $fullurl, array $fetchdef): array
    {
