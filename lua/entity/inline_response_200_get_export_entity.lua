...
local InlineResponse200GetExportEntity = {}
InlineResponse200GetExportEntity.__index = InlineResponse200GetExportEntity


function InlineResponse200GetExportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InlineResponse200GetExportEntity)
  self._name = "inline_response_200_get_export"
  self._client = client
...
function InlineResponse200GetExportEntity:get_name()
  return self._name
end


function InlineResponse200GetExportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InlineResponse200GetExportEntity.new(self._client, opts)
end
...
function InlineResponse200GetExportEntity:mark_deleted()
  self._deleted = true
end


function InlineResponse200GetExportEntity:deleted()
  return true == self._deleted
end


function InlineResponse200GetExportEntity:data_set(args)
  if args ~= nil then
...
function InlineResponse200GetExportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InlineResponse200GetExportEntity:match_set(args)
  if args ~= nil then
...
function InlineResponse200GetExportEntity:match_get()
...
function InlineResponse200GetExportEntity:stream(action, args, callopts)
...
---@param reqmatch InlineResponse200GetExportLoadMatch
---@param ctrl? table
---@return InlineResponse200GetExport
---@return string? err
function InlineResponse200GetExportEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata InlineResponse200GetExportCreateData
---@param ctrl? table
---@return InlineResponse200GetExport
---@return string? err
function InlineResponse200GetExportEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function InlineResponse200GetExportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return InlineResponse200GetExportEntity
