...
from branchcustomexports_sdk.branchcustomexports_types import (
    InlineResponse200GetExport,
    InlineResponse200GetExportLoadMatch,
    InlineResponse200GetExportCreateData,
)
...
class InlineResponse200GetExportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InlineResponse200GetExportEntity(self._client, opts)
    ...
    def data_get(self) -> InlineResponse200GetExport:
    ...
    def match_get(self) -> InlineResponse200GetExport:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InlineResponse200GetExport:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InlineResponse200GetExport().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: InlineResponse200GetExportCreateData, ctrl=None) -> InlineResponse200GetExport:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
