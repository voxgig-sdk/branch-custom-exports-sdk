...
// BranchCustomExports SDK pipeline test
//
...
{
    private static function utility(): BranchCustomExportsUtility
    {
        return new BranchCustomExportsUtility();
    }
    ...
    private static function ctx(array $over = []): BranchCustomExportsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BranchCustomExportsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BranchCustomExportsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BranchCustomExportsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BranchCustomExportsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BranchCustomExportsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BranchCustomExportsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BranchCustomExportsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BranchCustomExportsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BranchCustomExportsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchCustomExportsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BranchCustomExportsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BranchCustomExportsResponse([]),
            'result' => new BranchCustomExportsResult([]),
        ]);
        [, $err] = BranchCustomExportsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec([]),
            'response' => null,
            'result' => new BranchCustomExportsResult([]),
        ]);
        [, $err] = BranchCustomExportsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec(['step' => 's']),
            'response' => new BranchCustomExportsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BranchCustomExportsResult([]),
        ]);
        [, $err] = BranchCustomExportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec(['step' => 's']),
            'response' => new BranchCustomExportsResponse(self::resp(200, ['v' => 1])),
            'result' => new BranchCustomExportsResult([]),
        ]);
        [, $err] = BranchCustomExportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec(['step' => 's']),
            'response' => new BranchCustomExportsResponse(self::resp(200, ['v' => 2])),
            'result' => new BranchCustomExportsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BranchCustomExportsMakeResponse::call($ctx);
    ...
    {
        $preset = new BranchCustomExportsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec([]),
            'response' => new BranchCustomExportsResponse([]),
            'result' => new BranchCustomExportsResult([]),
        ...
        [$got, $err] = BranchCustomExportsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BranchCustomExportsResult([])]);
        [, $err] = BranchCustomExportsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BranchCustomExportsSpec([]), 'result' => null]);
        [, $err] = BranchCustomExportsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchCustomExportsSpec(['step' => 's']),
            'result' => new BranchCustomExportsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BranchCustomExportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchCustomExportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchCustomExportsSpec(['step' => 's']),
            'result' => new BranchCustomExportsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BranchCustomExportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchCustomExportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchCustomExportsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BranchCustomExportsSpec([]),
            'result' => new BranchCustomExportsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BranchCustomExportsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchCustomExportsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BranchCustomExportsError('boom', 'boom');
        $utility->fetcher = function (BranchCustomExportsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchCustomExportsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BranchCustomExportsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BranchCustomExportsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BranchCustomExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BranchCustomExportsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BranchCustomExportsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BranchCustomExportsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchCustomExportsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BranchCustomExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BranchCustomExportsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BranchCustomExportsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BranchCustomExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BranchCustomExportsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BranchCustomExportsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BranchCustomExportsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BranchCustomExportsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BranchCustomExportsResult(['ok' => false])]);
        $this->expectException(BranchCustomExportsError::class);
        BranchCustomExportsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BranchCustomExportsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BranchCustomExportsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BranchCustomExportsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BranchCustomExportsBaseFeature();
        $b = new BranchCustomExportsBaseFeature();
        BranchCustomExportsFeatureAdd::call($ctx, $a);
        BranchCustomExportsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BranchCustomExportsBaseFeature
    {
        $f = new BranchCustomExportsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BranchCustomExportsFeatureAdd::call($ctx, self::named_feature('a'));
        BranchCustomExportsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BranchCustomExportsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BranchCustomExportsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BranchCustomExportsFeatureAdd::call($ctx, $replace);
        ...
        BranchCustomExportsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BranchCustomExportsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BranchCustomExportsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchCustomExportsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BranchCustomExportsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BranchCustomExportsResponse(['headers' => null]),
            'result' => new BranchCustomExportsResult([]),
        ]);
        BranchCustomExportsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BranchCustomExportsResultBody::call($ctx);
