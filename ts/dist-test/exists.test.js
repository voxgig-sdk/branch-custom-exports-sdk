...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // BranchCustomExportsSDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        ...
        (0, node_assert_1.equal)(testsdk instanceof __1.BranchCustomExportsSDK, true, 'BranchCustomExportsSDK.test() must return a client synchronously');
    });
});
