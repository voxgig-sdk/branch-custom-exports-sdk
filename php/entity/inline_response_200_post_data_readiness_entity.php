...
class InlineResponse200PostDataReadinessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "inline_response_200_post_data_readiness";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new InlineResponse200PostDataReadinessEntity($this->_client, $opts);
    }

    /**
     * @param InlineResponse200PostDataReadiness|array $args InlineResponse200PostDataReadiness data (assoc-array) to store.
     */
    ...
    /**
     * @return InlineResponse200PostDataReadiness|array The current InlineResponse200PostDataReadiness data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InlineResponse200PostDataReadiness fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InlineResponse200PostDataReadiness fields).
     */
    ...
    /**
     * Create a new InlineResponse200PostDataReadiness.
     *
     * @param InlineResponse200PostDataReadinessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InlineResponse200PostDataReadinessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InlineResponse200PostDataReadiness|array The created InlineResponse200PostDataReadiness as an assoc-array at the
