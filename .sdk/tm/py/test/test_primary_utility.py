...
from projectname_sdk import BranchCustomExportsSDK
from projectname_sdk.core.spec import BranchCustomExportsSpec
from projectname_sdk.core.result import BranchCustomExportsResult
from projectname_sdk.core.operation import BranchCustomExportsOperation
from projectname_sdk.core.error import BranchCustomExportsError
from projectname_sdk.feature.base_feature import BranchCustomExportsBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, BranchCustomExportsSDK.test(None, None))
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BranchCustomExportsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BranchCustomExportsSDK.test(None, None)
        utility = client._utility
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = BranchCustomExportsResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = BranchCustomExportsSDK.test(None, None)
        ...
        class TestInitFeature(BranchCustomExportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BranchCustomExportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = BranchCustomExportsSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = BranchCustomExportsSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchCustomExportsSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchCustomExportsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BranchCustomExportsSDK.test(None, setup.get('a') or {})
    ...
    def test_operator_basic(self):
        def subject(vin):
            if not isinstance(vin, dict):
                vin = {}
            op = BranchCustomExportsOperation(vin)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BranchCustomExportsSDK.test(None, setup.get('a') or {})
