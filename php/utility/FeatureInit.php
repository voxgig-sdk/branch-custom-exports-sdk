...
// BranchCustomExports SDK utility: feature_init

class BranchCustomExportsFeatureInit
{
    public static function call(BranchCustomExportsContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
