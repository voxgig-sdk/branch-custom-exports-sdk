...
from branchcustomexports_sdk.branchcustomexports_types import (
    ...
    InlineResponse200PostDataReadinessCreateData,
)
...
class InlineResponse200PostDataReadinessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InlineResponse200PostDataReadinessEntity(self._client, opts)
    ...
    def data_get(self) -> InlineResponse200PostDataReadiness:
    ...
    def match_get(self) -> InlineResponse200PostDataReadiness:
    ...
    def create(self, reqdata: InlineResponse200PostDataReadinessCreateData, ctrl=None) -> InlineResponse200PostDataReadiness:
        utility = self._utility
