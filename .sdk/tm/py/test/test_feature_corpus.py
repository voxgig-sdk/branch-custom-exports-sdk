# BranchCustomExports SDK feature corpus test
#
...
def _client(kase):
    ...
    BranchCustomExportsSDK(...), not BranchCustomExportsSDK.test(...): the `test` feature is
    ...
    return BranchCustomExportsSDK(opts)
