...
// BranchCustomExports SDK utility: graphql
//
...
class BranchCustomExportsGraphql
{
    ...
    // equivalent.
    public static function body(BranchCustomExportsContext $ctx): mixed
    {
    ...
    public static function errors(BranchCustomExportsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
