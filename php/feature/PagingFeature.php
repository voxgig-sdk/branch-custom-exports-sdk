...
// BranchCustomExports SDK paging feature
...
class BranchCustomExportsPagingFeature extends BranchCustomExportsBaseFeature
{
    ...
    private function _graphql_pre_request(BranchCustomExportsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchCustomExportsContext $ctx): bool
    {
