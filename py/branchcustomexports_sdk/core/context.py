...
from branchcustomexports_sdk.core.control import BranchCustomExportsControl
...
from branchcustomexports_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchCustomExportsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BranchCustomExportsControl()
        ...
        if isinstance(sp, BranchCustomExportsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchCustomExportsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchCustomExportsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BranchCustomExportsOperation({})
        ...
        op = BranchCustomExportsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BranchCustomExportsError(code, msg, self)
