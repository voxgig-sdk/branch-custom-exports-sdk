...
(0, node_test_1.describe)('InlineResponse200PostExportEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'inline_response_200_post_export.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/inline_response_200_post_export/InlineResponse200PostExportTestData.json');
    ...
    let idmap = transform(['inline_response_200_post_export01', 'inline_response_200_post_export02', 'inline_response_200_post_export03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=InlineResponse200PostExportEntity.test.js.map