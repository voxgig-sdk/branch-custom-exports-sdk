...
function envOverride(m) {
    if ('TRUE' === process.env.BRANCH_CUSTOM_EXPORTS_TEST_LIVE ||
        'TRUE' === process.env.BRANCH_CUSTOM_EXPORTS_TEST_OVERRIDE) {
    ...
    m.BRANCH_CUSTOM_EXPORTS_TEST_EXPLAIN = process.env.BRANCH_CUSTOM_EXPORTS_TEST_EXPLAIN || m.BRANCH_CUSTOM_EXPORTS_TEST_EXPLAIN;
    return m;
}
