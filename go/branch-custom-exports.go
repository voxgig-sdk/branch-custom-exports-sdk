package voxgigbranchcustomexportssdk

import (
	"github.com/voxgig-sdk/branch-custom-exports-sdk/go/core"
	"github.com/voxgig-sdk/branch-custom-exports-sdk/go/entity"
	"github.com/voxgig-sdk/branch-custom-exports-sdk/go/feature"
	_ "github.com/voxgig-sdk/branch-custom-exports-sdk/go/utility"
)

// Type aliases preserve external API.
type BranchCustomExportsSDK = core.BranchCustomExportsSDK
type Context = core.Context
type Utility = core.Utility
type Feature = core.Feature
type Entity = core.Entity
type BranchCustomExportsEntity = core.BranchCustomExportsEntity
...
type BranchCustomExportsError = core.BranchCustomExportsError
...
func init() {
	...
	core.NewInlineResponse200GetExportEntityFunc = func(client *core.BranchCustomExportsSDK, entopts map[string]any) core.BranchCustomExportsEntity {
		return entity.NewInlineResponse200GetExportEntity(client, entopts)
	}
...
var NewBranchCustomExportsSDK = core.NewBranchCustomExportsSDK
...
// instead of `sdk.NewBranchCustomExportsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *BranchCustomExportsSDK  { return NewBranchCustomExportsSDK(nil) }
func Test() *BranchCustomExportsSDK { return TestSDK(nil, nil) }
