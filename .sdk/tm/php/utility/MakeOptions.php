...
// BranchCustomExports SDK utility: make_options

class BranchCustomExportsMakeOptions
{
    ...
    public static function call(BranchCustomExportsContext $ctx): array
    {
        ...
        //
        // `BranchCustomExportsSchema::optspec()` is built from the model:
        ...
        $optspec = BranchCustomExportsSchema::optspec();
