# BranchCustomExports JavaScript SDK



The JavaScript SDK for the BranchCustomExports API — an entity-oriented client with full async/await support.
...
## Install
```js
npm install branch-custom-exports
```
...
### Load an InlineResponse200GetExport

```js
const inline_response_200_get_export = await client.InlineResponse200GetExport().load({ request_handle: 'example_request_handle', format: 'example_format', limit: 1 })
console.log(inline_response_200_get_export)
```
...
├── src/
│   ├── BranchCustomExportsSDK.js        # Main SDK class
