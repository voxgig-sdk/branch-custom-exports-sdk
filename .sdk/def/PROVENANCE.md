...
## branch-custom-exports-openapi.json

- **Source:** https://help.branch.io/llms.txt → the `apidocs` reference pages
  for the **Custom Exports API**. Branch's documentation site publishes OpenAPI
...
- **Size:** 49104 bytes
- **Coverage:** 3 paths, 3 methods, 15 component schemas —
