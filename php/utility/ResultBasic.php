...
// BranchCustomExports SDK utility: result_basic

class BranchCustomExportsResultBasic
{
    public static function call(BranchCustomExportsContext $ctx): ?BranchCustomExportsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BranchCustomExportsError) ? $result->err->msg : (string)$result->err;
