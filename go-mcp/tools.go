...
type Args struct {
	Entity string         `json:"entity" jsonschema:"inline_response_200_get_export | inline_response_200_post_data_readiness | inline_response_200_post_export"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchCustomExportsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-custom-exports_list",
		Description: "List records from BranchCustomExports. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-custom-exports_load",
		Description: "Load a single record from BranchCustomExports. " +
...
func runOp(client *sdk.BranchCustomExportsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchCustomExportsSDK, name string) (sdk.BranchCustomExportsEntity, error) {
	switch strings.ToLower(name) {
	case "inline_response_200_get_export":
		return client.InlineResponse200GetExport(nil), nil
	case "inline_response_200_post_data_readiness":
		return client.InlineResponse200PostDataReadiness(nil), nil
	case "inline_response_200_post_export":
		return client.InlineResponse200PostExport(nil), nil
