...
// BranchCustomExports SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchCustomExportsSDK::test)
...
{
    private const SDK_CLASS = 'BranchCustomExportsSDK';
    ...
    private const SDK_BASE = 'branchcustomexports_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchcustomexports_sdk.php';
