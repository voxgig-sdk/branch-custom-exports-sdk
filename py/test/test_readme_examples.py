# BranchCustomExports SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchCustomExportsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchCustomExportsSDK(...) and BranchCustomExportsSDK.test(...) become
#      BranchCustomExportsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchcustomexports_sdk"
_SDK_CLASS = "BranchCustomExportsSDK"
