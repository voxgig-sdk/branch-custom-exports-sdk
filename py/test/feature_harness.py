# BranchCustomExports SDK feature test harness
#
...
from branchcustomexports_sdk.features import _make_feature
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else BranchCustomExportsControl()
        self.meta = {}
        self.op = op
        self.entity = entity
...
class Harness:
    ...
    def _populate_result(self, ctx, response, fetch_err):
        result = BranchCustomExportsResult({})
        ctx.result = result
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=BranchCustomExportsControl(ctrl or {}))
