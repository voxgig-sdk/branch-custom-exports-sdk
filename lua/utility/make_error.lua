...
local function make_error_util(ctx, err)
  ...
  local msg = "BranchCustomExportsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BranchCustomExportsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BranchCustomExportsError then
