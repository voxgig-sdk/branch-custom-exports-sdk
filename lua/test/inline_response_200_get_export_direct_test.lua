...
describe("InlineResponse200GetExportDirect", function()
  it("should direct-load-inline_response_200_get_export", function()
    local setup = inline_response_200_get_export_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-inline_response_200_get_export", setup.live and "live" or "unit")
...
function inline_response_200_get_export_direct_setup(mockres)
