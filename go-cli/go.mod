module github.com/voxgig-sdk/branch-custom-exports-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/branch-custom-exports-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/branch-custom-exports-sdk/go => ../go
