...
from branchcustomexports_sdk.core.spec import BranchCustomExportsSpec
from branchcustomexports_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from branchcustomexports_sdk.utility import register

# Load features
from branchcustomexports_sdk.feature.base_feature import BranchCustomExportsBaseFeature
from branchcustomexports_sdk.features import _has_feature, _make_feature
...
class BranchCustomExportsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchCustomExportsUtility()
        self._utility = utility

        from branchcustomexports_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchCustomExportsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchCustomExportsSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def InlineResponse200GetExport(self, data=None) -> "InlineResponse200GetExportEntity":
        """Entity factory: client.InlineResponse200GetExport().list() / client.InlineResponse200GetExport().load({"id": ...})."""
        from branchcustomexports_sdk.entity.inline_response_200_get_export_entity import InlineResponse200GetExportEntity
        return InlineResponse200GetExportEntity(self, data)


    def InlineResponse200PostDataReadiness(self, data=None) -> "InlineResponse200PostDataReadinessEntity":
        """Entity factory: client.InlineResponse200PostDataReadiness().list() / client.InlineResponse200PostDataReadiness().load({"id": ...})."""
